...
function LayoutBox (boxType, dimensions, children) {
    ...
    let layoutBox = {
        ...
        calculateBlockWidth = function (containingBlock) {
            ...
            let width = style.value('width') || new Value().Keyword('auto');

            // margin, border, and padding have initial value 0.
            let zero = new Value().Length(0.0, new Unit().Px());
            ...
            let paddingLeft = style.lookup('padding-left-width', 'padding', zero);
            let paddingRight = style.lookup('padding-right-width', 'padding', zero);

            let total = [marginLeft, marginRight, borderLeft, borderRight,
            ...
            let widthIsAuto = isAuto(width);
            let marginLeftIsAuto = isAuto(marginLeft);
            let marginRightIsAuto = isAuto(marginRight);
        ...
        calculateBlockHeight = function () {
            ...
            let height = styleNode.value('height');
